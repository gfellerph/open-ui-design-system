...
<Preview style="./input.css" markup="./input.html" />
...
<Tabs>
  <TabItem title="Usage">
    ...
    <CodeBlock style="./input.css" markup="./input.html" />
  </TabItem>
  <TabItem title="Props">
    ## Props
  ...
  <TabItem title="Availability">
    ...
    <baseline-status featureid="label" display="wide"></baseline-status>
    <baseline-status featureid="input" display="wide"></baseline-status>
  </TabItem>
</Tabs>